...
const routeInventory = [
  ...
  { url: '/contracts/:contractId', route: 'app/contracts/[contractId]/page.tsx', client: 'src/contracts/detail.tsx', api: ['/api/contracts/', '/detail', '/review', '/acceptances'], primary: 'Sign and accept exact Version', rendered: 'Loading Contract detail' },
