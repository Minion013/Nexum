...
const routeInventory = [
  ...
  { url: '/contracts/:contractId/milestones/:milestoneKey', route: 'app/contracts/[contractId]/milestones/[milestoneKey]/page.tsx', client: 'src/contracts/milestone-review.tsx', support: ['src/contracts/milestone-review-presentation.ts'], api: ['/api/contracts/', '/milestones/', '/review', '/evidence', '/decisions'], primary: 'Submit final evidence', rendered: 'Loading Milestone Review' },
  { url: '/contracts/:contractId/accept', route: 'app/contracts/[contractId]/accept/page.tsx', client: 'src/contracts/acceptance.tsx', support: ['src/contracts/wallet-acceptance.tsx'], api: ['/api/contracts/', '/review', '/acceptances'], primary: 'Accept exact Version', rendered: 'Loading Version review' },
  { url: '/wallet', route: 'app/wallet/page.tsx', client: 'src/wallet/wallet.tsx', support: ['src/auth/client.ts'], api: ['/api/auth/config'], primary: 'Load wallet connection', rendered: 'Personal test funds, kept separate' },
