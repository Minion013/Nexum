...
- **Heading Font:** Fira Code (for data labels and rare monospaced metadata only)
- **Body Font:** Fira Sans
- **Mood:** clear, calm, collaborative, precise
- **Google Fonts:** [Fira Code + Fira Sans](https://fonts.googleapis.com/css2?family=Fira+Code:wght@400;500;600&family=Fira+Sans:wght@400;500;600;700&display=swap)
