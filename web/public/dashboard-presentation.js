...
function attentionAction(contract) {
  ...
  return attention && { contractId: contract.id, title: attention.title, detail: attention.detail(title, contract.counterparty), href: `/contracts/${encodeURIComponent(contract.id)}`, label: attention.label };
}
