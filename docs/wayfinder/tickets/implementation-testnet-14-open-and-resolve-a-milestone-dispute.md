# 14 — Open and resolve a milestone dispute in Contract context

**What to build:** The Buyer can freeze one timely disputed milestone, and the Contract’s bound resolution authority can select only the payment outcome the Contract allows. Authorities and case officers remain operational capabilities, not post-login personas or general navigation destinations.

**Blocked by:** 10 — Record final seller delivery evidence.
