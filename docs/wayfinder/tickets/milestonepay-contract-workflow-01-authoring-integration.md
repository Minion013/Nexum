...
- Verified locally: focused tests and the full 67-test suite, typecheck, production build, and `git diff --check` pass. The linked migration dry run selected only `20260810110000_require_milestone_acceptance_criteria.sql`; it was applied successfully on 2026-08-10.
