...
**What to build:** People provides My network for accepted professional connections and Requests for pending connection activity, allowing a user to send, receive, accept, decline, withdraw, or remove connections while keeping those relationships separate from Workspace membership and Contract Party access.
...
- [ ] Connection actions neither create Workspace membership nor grant Contract access.
