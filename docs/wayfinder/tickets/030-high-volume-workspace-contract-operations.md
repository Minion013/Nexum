...
assignee: Codex
blocked_by:
  - 023-workspace-contracts-and-proposals.md
---

# High-volume Workspace Contract operations

## Question

What pagination, filtering persistence, bulk actions, selection safeguards, and mobile equivalents keep a high-volume Workspace Contracts view usable without weakening existing Contract visibility boundaries?
