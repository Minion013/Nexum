...
1. [Deliver four-step Contract Draft authoring](tickets/milestonepay-contract-workflow-01-authoring-integration.md) — **in-progress 2026-08-10 / current frontier**: the accessible four-step authoring flow, generated editable milestones, Acceptance Criteria flags, proposed-terms language, and protected create/version/invite composition are implemented. Focused and full 67-test coverage, typecheck, build, and diff checks pass; Review terms needs complete direct section editing and mocked page-flow coverage. The linked Acceptance Criteria migration is dry-run verified but awaits explicit approval to apply, followed by linked authenticated-browser Send verification.
