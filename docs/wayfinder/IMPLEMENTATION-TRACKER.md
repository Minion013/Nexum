...
The [complete Next.js TypeScript and backend conversion specification](complete-nextjs-typescript-and-backend-conversion-spec.md) is the delivery source for replacing the interim static-page migration. All frontend pages must become typed Next.js routes, while each interactive page receives complete authorised backend support. Ticket 06 is complete; Ticket 07 is now the next listed conversion ticket and is currently marked blocked by Ticket 02.

Tickets 01 through 06 are complete; Ticket 02's dependency is satisfied and Ticket 07 remains marked blocked by Ticket 02.
